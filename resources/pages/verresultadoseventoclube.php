...
$clube = $DAO5->obter_detalhes_clube_userid($_SESSION['U_ID']);
...
<?php }else{ ?>
  ...
  function addProvas(idbotao){
    window.location.href = "?action=verresultadoseventoclube&id="+<?php echo $eventoid ?> +"&prova=" + idbotao;
  }
</script>
<?php
if(isset($_GET["prova"])){
          ...
          <table class="table table-hover table-striped">
            ...
            <tbody>
              ...
              do{
                ...
                <tr>
                  <?php
                  if($DAO4->verificar_atleta_clube($resultadosprova[$x]->get_atletaid(),$clube->get_id())){
